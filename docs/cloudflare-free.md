...
| Workers AI     | Yes, 10,000 neurons/day                | A shipped binding could spend the daily allowance without the workspace asking for it                    | Binding declared but inert until an admin enables AI in Settings; bounded output, chunked translation; over the allowance calls fail as `503` and drafts are untouched |
