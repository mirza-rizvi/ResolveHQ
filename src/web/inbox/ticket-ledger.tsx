            ...
            <tbody>
              {tickets.map((ticket) => (
                <tr key={ticket.id} className={ticket.id === ticketId ? "selected" : ""}>
                  ...
                  <td>
                    <Link className="ticket-subject-link" to={`/inbox/${ticket.id}?${params}`}>
                      {ticket.subject}
                    </Link>
                  </td>
                  <td>{ticket.customerName}</td>
                  <td>
                    <span className={ticket.assigneeName ? "assignee-label" : "assignee-label unassigned"}>
...
function LedgerSkeleton() {
  return (
    <div className="ledger-skeleton" aria-label="Loading tickets">
      <span />
      <span />
      <span />
      <span />
