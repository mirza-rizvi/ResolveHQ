...
VALUES
  ('usr_owner', 'owner@northstarlabs.test', 'Maya Chen', 'pbkdf2-sha256$310000$5YVp6WPqIjWJg4XXdTp-hg$9Nmm8_oWqdlzk1Nue8_g3IW70I2188c-voY1vAR6BJk', 1788192000000, 1788192000000),
  ('usr_agent', 'alex@northstarlabs.test', 'Alex Morgan', 'pbkdf2-sha256$310000$5YVp6WPqIjWJg4XXdTp-hg$9Nmm8_oWqdlzk1Nue8_g3IW70I2188c-voY1vAR6BJk', 1788192000000, 1788192000000);
...
INSERT OR IGNORE INTO tickets (id, organization_id, number, customer_id, subject, status, priority, assigned_user_id, normalized_search, last_reply_at, created_at, updated_at)
VALUES
  ('tkt_1001', 'org_demo', 1001, 'cus_lina', 'Webhook deliveries retrying indefinitely', 'open', 'high', 'usr_agent', '1001 webhook deliveries retrying indefinitely lina park lina@papertrail.test', 1788275700000, 1788264000000, 1788275700000),
  ('tkt_1002', 'org_demo', 1002, 'cus_omar', 'Need a copy of our August invoice', 'waiting_customer', 'normal', 'usr_owner', '1002 need a copy of our august invoice omar haddad omar@relaycart.test', 1788269400000, 1788250000000, 1788269400000),
  ('tkt_1003', 'org_demo', 1003, 'cus_sophie', 'Checkout extension conflicts with theme', 'open', 'urgent', NULL, '1003 checkout extension conflicts with theme sophie laurent sophie@acorn.test', 1788180000000, 1788170000000, 1788180000000);
